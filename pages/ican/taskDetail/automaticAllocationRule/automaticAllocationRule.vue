<template>
	<view class="">
		<view class="container">
			...
			<view class="">
				<view class="color_666769" style="margin-bottom: 60rpx;">
					<view class="">
						1、设置后会在您的账户中将输入的分配能贝暂时锁定;
					</view>
					<view class="">
						2、在您确认完成后，将平均分配给处于参与任务的并且标记任务完成的所有成员。
					</view>
				</view>
				<view class="">
					<view class="">
						<text class="bold">请注意:</text>
					</view>
					<view class="color_666769">
						<view class="">
							1、任务结束前，参与任务并完成的人员只剩余1个，会将全部的分配给予该成员。
						</view>
						<view class="">
							2、若完成前，所有参与人员退出，那么您设置的能贝将在您的选择完成后完整退回您的账户。
						</view>
					</view>
				</view>
			</view>
