<template>
	<view class="uni-load-more" @click="onClick">
		<!-- #ifdef APP-NVUE -->
		<loading-indicator v-if="!webviewHide && status === 'loading' && showIcon" :style="{color: color,width:iconSize+'rpx',height:iconSize+'rpx'}" :animating="true" class="uni-load-more__img uni-load-more__img--nvue"></loading-indicator>
		<!-- #endif -->
		<!-- #ifdef H5 -->
		...
		:style="{width:iconSize+'rpx',height:iconSize+'rpx'}" class="uni-load-more__img uni-load-more__img--android-H5">
		...
		:style="{width:iconSize+'rpx',height:iconSize+'rpx'}" class="uni-load-more__img uni-load-more__img--android-MP">
		...
		<!-- #endif -->
		<!-- #ifndef APP-NVUE -->
		<view v-else-if="!webviewHide && status === 'loading' && showIcon" :style="{width:iconSize+'rpx',height:iconSize+'rpx'}" class="uni-load-more__img uni-load-more__img--ios-H5">
